...
const NAV = [
  ...
  { id: "patterns", label: "Patterns", icon: "patterns", count: 1427 },
  { id: "skills",   label: "Skills",   icon: "skills",   count: 23, badge: 6 },
  { id: "projects", label: "Projects", icon: "projects", count: 8 },
  { id: "drift",    label: "Drift",    icon: "drift",    count: 312 },
  { id: "sessions", label: "Sessions", icon: "sessions", count: 94 },
];
const NAV_BOTTOM = [
  { id: "bug-report", label: "Bug Report", icon: "bug-report", badge: 1 },
      ...
      <aside className="sidebar">
        <div className="brand">
          ...
          <div className="brand-meta">
            <div className="brand-name">ensemble-mcp <span className="brand-version">v0.1.0b7</span></div>
        ...
        <div className="sidebar-footer">
          ...
          <span className="sidebar-footer-meta">{fmtUptime(MOCK.health.uptime_seconds).split(" ").slice(0,2).join(" ")}</span>
        </div>
      </aside>
