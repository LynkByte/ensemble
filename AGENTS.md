...
- **Session**: `session_save`, `session_load`, `session_search`
- **Indexer**: `project_index`, `project_query`, `project_dependencies`, `project_snapshot`
- **Compress**: `context_compress`, `context_prepare`
